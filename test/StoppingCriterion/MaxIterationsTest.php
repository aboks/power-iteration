...
class MaxIterationsTest extends TestCase {
	...
	public function testContinuesIfTheMaximumNumberOfIterationsIsNotReached() {
		...
		$this->assertFalse($this->stopping_criterion->shouldStop(41, $matrix, $eigenvector_approximation, $eigenvalue_approximation));
	}
	...
	public function testStopsIfTheMaximumNumberOfIterationsIsReached() {
		...
		$this->assertTrue($this->stopping_criterion->shouldStop(42, $matrix, $eigenvector_approximation, $eigenvalue_approximation));
		$this->assertTrue($this->stopping_criterion->shouldStop(43, $matrix, $eigenvector_approximation, $eigenvalue_approximation));
	}
}